...
class Attention_layer(object if debug_flag else Layer):
    ...
    def __call__(self, inputs, training=None, **kwargs):
        if debug_flag:
            ...
            return super(Attention_layer, self).__call__(inputs, training, **kwargs)
    ...
    def get_config(self):
        ...
        """
        config = super(Attention_layer, self).get_config()
